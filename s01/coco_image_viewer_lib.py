# comes from https://github.com/akTwelve/cocosynth
import base64
import json
...
class CocoDataset():
    ...
    def display_image(self, image_id, show_bbox=True, show_polys=True, show_crowds=True):
        ...
        # Print image info
        # print('Print image info',image_id)
        # print(self.images)
    ...
    def ensure(self, param):
        if param not in self.coco:
            self.coco[param] = {}
...
if __name__ == '__main__':
    ...
    dataset_folder = "/datasets/partial_coco2017"
    instances_json_path = ".%s/annotations/instances_val2017.json" % dataset_folder
    ...
    # html = coco_dataset.display_image(397133)
    html = coco_dataset.display_image(581781)
